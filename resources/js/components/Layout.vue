  ...
  <div class="flexible-content">
      ...
      <mdb-navbar-toggler>
       ...
       <mdb-navbar-nav right>
          ...
          <mdb-nav-item>
            ...
            target="_blank" >
            <mdb-icon icon="user-circle" far class="mr-2" />Log Out </button>
          </mdb-nav-item>
        </mdb-navbar-nav>
      </mdb-navbar-toggler>
    </mdb-navbar>
    <div class="sidebar-fixed position-fixed">
      ...
      <mdb-list-group class="list-group-flush">
        ...
        <router-link to="/product" @click.native="activeItem = 8">
          <mdb-list-group-item
            :action="true"
            :class="activeItem === 8 && 'active'"
            ><mdb-icon icon="table" class="mr-3" />Products</mdb-list-group-item
          >
        </router-link>
        ...
        <!-- <router-link to="/dashboardTwo" @click.native="activeItem = 6">
          <mdb-list-group-item
            :action="true"
